...
class _PharmacyPageState extends State<PharmacyPage> {
  final ShopsScroller categoriesScroller = ShopsScroller();
...
class ShopsScroller extends StatelessWidget {
  const ShopsScroller();
              ...
              Container(
                ...
                child: Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: <Widget>[
                      Text("\n\nMore pharmacy coming soon!",style: TextStyle(fontSize: 16, color: Colors.white)),
                      SizedBox(
                        height: 10,
                      ),
                    ],
